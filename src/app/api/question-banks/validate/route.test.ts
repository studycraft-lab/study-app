...
const validBank = {
  ...
  sources: [{ id: "page-45", pageNumber: 45, assetRef: "manifest://test/page-45", extractionConfidence: 1, reviewRequired: false, regions: [] }],
  ...
  questions: [
    {
      ...
      sourceRefs: [{ pageId: "page-45", supports: ["prompt", "answer", "rubric"] }],
      response: { blankCount: 1 },
      answer: { accepted: ["Sapta Sindhu"] },
      rubric: { exact: true },
      hint: "Its name means the region of seven rivers.",
      explanation: "The region was called Sapta Sindhu.",
