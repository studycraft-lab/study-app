...
function learningBrief(summary: Progress["history"]["summary"]) {
  if (summary.completedSessions === 0) return "Their first constellation is waiting to be revealed.";
