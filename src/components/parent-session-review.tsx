...
export function ParentSessionReview() {
  ...
  return <main className="parent-shell"><AppHeader role="parent" /><section className="parent-intro"><Link href="/parent/family">← Back to children & progress</Link><p className="eyebrow">Parent review</p><h1>Answers needing review</h1><p>Resolve score appeals here. Question-quality reports remain in the content library.</p></section>
    ...
    {!error && !children.length && !appeals.length && <p className="study-loading">Loading reviews…</p>}
