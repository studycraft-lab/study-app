...
export function StudyExperience({ tutorEnabled = false }: { tutorEnabled?: boolean }) {
  ...
  const subjects = [...new Set(chapters.map((chapter) => chapter.subject))].sort((a, b) => a.localeCompare(b));
